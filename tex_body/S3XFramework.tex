...
\end{align}
 ...
 The problem is not solved on $\vec{j}$ itself but on the vorticity defined as $\Omega = \vec{\grad}\cdot\vec{\omega}_s$ which gives the expression on $\vec{j}_p$: 
