...
\subsubsection{Mass Balance (\textit{k} = 0)}
...
\subsubsection{Momentum Balance (\textit{k} = 1)}
...
\subsubsection{Energy Balance (\textit{k} = 2)}
...
\subsubsection{Electromagnetic mode excitation}
